      ...
      {showTerms && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          ...
          >
            ...
            <p>
              In order to use the Trackscendence website you must agree to the
              terms of service you are reading. You agree not to tamper with or
              otherwise hack the site in any way. You must agree to only use the
              website in the manner it was intended to be used, which is playing
              the Uno! card game, making friends, viewing profiles, chatting to
              other user on the website and other obvious uses of the website.
              You must agree not to use this website to commit any crimes,
              harass others, or otherwise conduct malicious activities. Uno! is
              not owned by any of the creator of this website and this website
              is not meant to be monetized in anyway. This website is meant for
      ...
      {showPrivacy && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          ...
          >
            ...
            <p>
              In order to use the Trackscendence website you must agree to the
              Privacy Policy you are reading. We do NOT share, give, or sell
              Trackscendence website user data in way shape or form. Emails used
              for authentication users at signup and possibly emailing uses
              about website updates. Chats that are made public are public, but
              private chat messages are not available to anyone other than the
              user that wrote them and who they personally share them with.
            </p>
            <button
              type="button"
              className="mt-6 rounded-md bg-[#2f7d61] px-4 py-2 text-white"
