        ...
        <div className="prose mt-8 space-y-8 text-sm leading-relaxed text-[#27352f]">
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              institution. You must be at least 13 years old to create an
              account. Accounts created on behalf of another person without
              their consent are not permitted.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="mt-2 list-disc space-y-1 pl-5">
              ...
              <li>
                You may only create one account per person. Duplicate accounts
          ...
          <section>
            ...
            <ul className="mt-2 list-disc space-y-1 pl-5">
              ...
              <li>
                Harass, threaten, or abuse other users through the chat or any
                other feature.
              </li>
              <li>
          ...
          <section>
            ...
            <p className="mt-2">
              Your username must not impersonate another person or contain
              offensive language. We reserve the right to rename or remove
              accounts with inappropriate usernames. You retain ownership of any
              content you submit (e.g., chat messages), but grant us a limited
              license to store and display it to other users.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              The Service is provided &quot;as is&quot; for educational
              purposes. We make no warranties regarding uptime, data durability,
              or fitness for any particular purpose. Game results and
              leaderboard data may be reset without notice during development.
            </p>
          </section>
