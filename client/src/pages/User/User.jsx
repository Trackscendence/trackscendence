...
// Public profile page: loads the viewed profile and renders the surface. The
// relationship control (add, cancel, accept/reject, message, unfriend) lives
// in ProfileSurface's RelationshipActions feature, not here.
const User = () => {
